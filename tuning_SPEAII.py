...
def target_runner(experiment, scenario):
    ...
    front = SPEAII.evolve(epoch, list_target_points, communication_graph, nb_zones, coordinates, nb_targets, num_of_tour_particips, tournament_prob, **experiment["configuration"])
...
parameters_table = '''    
crossover_param "" r (0.7, 0.9)
mutation_param "" r (0.01, 0.1)
pop_size  "" i (70, 150)
archive_size "" i (40, 50)
'''
