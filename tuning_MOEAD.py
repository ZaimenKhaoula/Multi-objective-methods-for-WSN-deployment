...
def target_runner(experiment, scenario):
    ...
    moea = MOEAD(epoch, list_target_points, communication_graph, nb_zones, coordinates, num_of_tour_particips, tournament_prob, crossover_param)
    front= moea.evolve(**experiment["configuration"])
